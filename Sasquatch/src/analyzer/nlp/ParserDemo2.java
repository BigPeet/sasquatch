...
public class ParserDemo2 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (args.length > 1) {
      DocumentPreprocessor dp = new DocumentPreprocessor("C:\\Users\\Peter Wolf\\Desktop\\sentences.txt");
      ...
      String[] sent = { "The", "interface", "is", "not", "flexible"};
...
//      System.out.println();
      ...
      System.out.println(td.gov().pennString().trim());
